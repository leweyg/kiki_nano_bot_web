(function (root, factory) {
  ...
  levelTemplates.captured = {
  "port_status": "being-ported",
  "portNotes": [
    "Six stone cage polygons and twelve axial stones.",
    "No route certified within the bounded search; full puzzle completion remains unverified."
  ],
  "size": { "x": 9, "y": 9, "z": 9 },
  "intro": "captured",
  ...
  // Source capture: circuit
  levelTemplates.circuit = {
  "port_status": "being-ported",
  "portNotes": [
    "Original seven-part wire circuit, eight wire stones and motor/generator. Wire face overlaps retained. Electrical exit activation is missing; exit remains closed."
  ],
  "size": { "x": 9, "y": 9, "z": 9 },
  "intro": "circuit",
  "help": [
  ...
  // Source capture: regal
  levelTemplates.regal = {
  "port_status": "being-ported",
  "portNotes": [
    "Original narrow wall corridors, gears, generators and motor pairs. Electrical exit activation is missing; exit remains closed."
  ],
  "size": { "x": 7, "y": 3, "z": 9 },
  "intro": "regal",
  "help": [
